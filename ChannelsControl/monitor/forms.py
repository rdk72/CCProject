...
class IncidentEditForm(forms.ModelForm):
    ...
    class Meta:
        model = Incident
        fields =  ['provider', 'channels', 'date_time_from', 'date_time_to', 'type', 'request_state', 'request', 'more_info', 'state' ]
